...
export const LORE_MATERIALS = [
    ...
    { name: "Argent",     icon: "🥈", particle: "de l'", color: "#cbd5e1", shadow: "#64748b" }, // Argent
    { name: "Or",         icon: "🥇", particle: "de l'", color: "#fbbf24", shadow: "#b45309" }, // Or
    { name: "Chrome",     icon: "💿", particle: "de ",  color: "#38bdf8", shadow: "#0ea5e9" }, // Bleu électrique
    { name: "Carbone",    icon: "🌚", particle: "de ",  color: "#71717a", shadow: "#27272a" }, // Gris sombre
    { name: "Titane",     icon: "🛡️", particle: "de ",  color: "#94a3b8", shadow: "#475569" }, // Bleu gris
    { name: "Plasma",     icon: "⚡", particle: "de ",  color: "#c084fc", shadow: "#9333ea" }, // Violet
    ...
    { name: "Obsidienne", icon: "🌋", particle: "d'",   color: "#1e293b", shadow: "#0f172a" }, // Noir bleu
    ...
    { name: "L'Absolu",   icon: "🌟", particle: "de ",  color: "#fcd34d", shadow: "#ffffff" }  // Or Blanc
];
...
export const BADGES = [
    ...
    // MIGRATION FROM SPECIAL TO GENERAL
    { id: 'b_duke', category: 'general', icon: '🎩', title: "The Duke", desc: "10 réussites consécutives sur Maj7/min7 (Acad.)", check: (d) => d.stats.str_jazz >= 10 },
    { id: 'b_007', category: 'general', icon: '🕵️', title: "Agent 007", desc: "10 réussites consécutives sur MinMaj7", check: (d) => d.stats.str_007 >= 10 },
    { id: 'b_dem', category: 'general', icon: '💣', title: "Démineur", desc: "10 réussites consécutives sur Dim7", check: (d) => d.stats.str_dim >= 10 },
    { id: 'b_acro', category: 'general', icon: '🤸', title: "L'Acrobate", desc: "10 réussites consécutives sur Renversements", check: (d) => d.stats.str_inv >= 10 },


    // --- CATÉGORIE: SPÉCIALISATIONS (Modes & Accords Spécifiques) ---
    { id: 'b_blue', category: 'special', setID: 'jazz', icon: '🎷', title: "Blue Note", desc: "Réussir 50 accords Jazz (Club)", check: (d) => { if(!d.stats.v) return false; let tot = 0; for(let k in d.stats.v) tot += d.stats.v[k].ok; return tot >= 50; }},
    { id: 'b_lab', category: 'special', setID: 'laboratory', icon: '🧪', title: "Rat de Labo", desc: "Réussir 50 accords Laboratoire", check: (d) => { if(!d.stats.l) return false; let tot = 0; for(let k in d.stats.l) tot += d.stats.l[k].ok; return tot >= 50; }},
    { id: 'b_grand', category: 'special', setID: 'academy', icon: '🌊', title: "Grand Large", desc: "Série de 15 sans faute en Mode Ouvert (Acad.)", check: (d, s) => s.openStreak >= 15 },
